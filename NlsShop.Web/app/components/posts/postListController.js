(function (app) {
    ...
    postListController.$inject = ['$scope', 'apiService', '$filter', 'notificationService', '$ngBootbox'];

    function postListController($scope, apiService, $filter, notificationService, $ngBootbox) {
        $scope.posts = [];
        $scope.page = 0;
        $scope.pagesCount = 0;
