                        ...
                        type: "hbox", children: [{
                            id: "basic", type: "vbox", children: [{
                                ...
                                type: "vbox", padding: 1, children: [{
                                    ...
                                    {
                                        id: "cmbAlign", requiredContent: "img{float}", type: "select", widths: ["35%", "65%"], style: "width:90px", label: d.lang.common.align, "default": "", items: [[d.lang.common.notSet, ""], [d.lang.common.alignLeft, "left"], [d.lang.common.alignRight, "right"], [d.lang.common.alignCenter, "center"]], onChange: function () { e(this.getDialog()); k.call(this, "advanced:txtdlgGenStyle") }, setup: function (a, b) { if (1 == a) { var c = b.getStyle("float"); switch (c) { case "inherit": case "none": c = "" }!c && (c = (b.getAttribute("align") || "").toLowerCase()); this.setValue(c) } }, commit: function (a,
                                            b) { var c = this.getValue(); if (1 == a || 4 == a) { if (c) switch (c.toLowerCase()) { case "left": b.setStyle("float", c); break; case "right": b.setStyle("float", c); break; case "center": b.setStyle('display', 'block'); b.setStyle('margin-left', 'auto'); b.setStyle('margin-right', 'auto'); } } else 8 == a && b.removeStyle("float"); }
                                }]
                            }]
                        }, {
